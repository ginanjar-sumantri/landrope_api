"""__riwayat for printout spk

Revision ID: fe88386c8ace
Revises: d0f34c7c91f3
Create Date: 2024-06-04 12:13:46.891125
...
revision = 'fe88386c8ace'
down_revision = 'd0f34c7c91f3'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_table('termin_bayar_dt',
    ...
    op.create_index(op.f('ix_termin_bayar_dt_id'), 'termin_bayar_dt', ['id'], unique=False)
    ...
    op.add_column('beban_biaya', sa.Column('activity_code', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
    op.add_column('spk_kelengkapan_dokumen', sa.Column('field_value', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
    op.add_column('spk_kelengkapan_dokumen', sa.Column('key_value', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('spk_kelengkapan_dokumen', 'key_value')
    op.drop_column('spk_kelengkapan_dokumen', 'field_value')
    op.drop_column('beban_biaya', 'activity_code')
    ...
    op.drop_index(op.f('ix_termin_bayar_dt_id'), table_name='termin_bayar_dt')
    op.drop_table('termin_bayar_dt')
    # ### end Alembic commands ###
