...
Revision ID: b1a85abe0876
Revises: a0d919f9ab15
Create Date: 2024-05-31 19:19:08.157628
...
revision = 'b1a85abe0876'
down_revision = 'a0d919f9ab15'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.add_column('kjb_dt', sa.Column('is_ptsl', sa.Boolean(), nullable=True))
