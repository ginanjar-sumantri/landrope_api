...
Revision ID: efcdf9b8ce97
Revises: 8ea2a14815c7
Create Date: 2024-02-15 17:23:29.067871
...
revision = 'efcdf9b8ce97'
down_revision = '8ea2a14815c7'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.alter_column('hasil_peta_lokasi_history', 'trans_worker_id',
               existing_type=postgresql.UUID(),
               nullable=True)
    op.alter_column('kjb_history', 'trans_worker_id',
               existing_type=postgresql.UUID(),
               nullable=True)
