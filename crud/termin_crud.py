...
from models import (Termin, Invoice, Tahap, Bidang, Skpt, TerminBayar, PaymentDetail, Payment, Planing, InvoiceDetail, InvoiceBayar,
                    BidangKomponenBiaya, Spk, PaymentGiroDetail)
    ...
    async def get_beban_biaya_by_id_for_printout(self, 
        ...
        query = text(f"""
                        ...
                        /*case
                                ...
                                when COALESCE(idt.beban_pembeli, bkb.beban_pembeli) is false and bkb.is_retur = true and t.jenis_bayar = 'PELUNASAN' then '(Pengembalian Beban Penjual)'
                                else '(Beban Penjual)'
                        end as tanggungan,*/
