...
#     kjb_hd:"KjbHd" = Relationship(back_populates="tanda_terima_notarists", sa_relationship_kwargs={'lazy':'selectin'})
#     kjb_dt:"KjbDt" = Relationship(back_populates="tanda_terima_notarists", sa_relationship_kwargs={'lazy':'selectin'})
#     jenis_surat:"JenisSurat" = Relationship(back_populates="tanda_terima_notarists", sa_relationship_kwargs={'lazy':'selectin'})
#     notaris:"Notaris" = Relationship(back_populates="tanda_terima_notarists", sa_relationship_kwargs={'lazy':'selectin'})
#     planing:"Planing" = Relationship(back_populates="tanda_terima_notarists", sa_relationship_kwargs={'lazy':'selectin'})
