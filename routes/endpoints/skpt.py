...
import crud
from models.skpt_model import Skpt, StatusSKEnum, KategoriSKEnum
from schemas.skpt_sch import (SkptSch, SkptCreateSch, SkptUpdateSch, SkptExtSch, SkptShpSch)
...
async def create(sch: SkptCreateSch):
...
async def update(id:UUID, sch:SkptUpdateSch):
...
#                           kategori=KategoriSKEnum.SK_ASG,
#                           luas=luas,
