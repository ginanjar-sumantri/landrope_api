...
from routes.endpoints import (bidang, bidang_overlap, bidang_komponen_biaya, bidang_history, desa, kjb_termin, planing, project, main_project, 
                              ...
                              report_map, dashboard, workflow, export_excel, report, report_pembebasan, attachment_file, rfp, peminjaman_header, peminjaman_bidang)
...
api_router.include_router(peminjaman_header.router, prefix="/peminjaman_header", tags=["peminjaman_header"])
...
api_router.include_router(report_pembebasan.router, prefix="/report_pembebasan", tags=["report_pembebasan"])
